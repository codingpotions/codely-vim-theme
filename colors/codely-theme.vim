  ...
  let s:guishade0 = "#202124"
  let s:guishade1 = "#3d3c38"
  let s:guishade2 = "#5a564d"
  let s:guishade3 = "#777161"
  let s:guishade4 = "#948b75"
  let s:guishade5 = "#b1a689"
  let s:guishade6 = "#cec09e"
  let s:guishade7 = "#ebdbb2"
  let s:guiaccent0 = "#ff5555"
  let s:guiaccent1 = "#fabd2f"
  let s:guiaccent2 = "#83a598"
  let s:guiaccent3 = "#b8bb26"
  let s:guiaccent4 = "#fb4934"
  let s:guiaccent5 = "#fb4934"
  let s:guiaccent6 = "#fb4934"
  let s:guiaccent7 = "#fb4934"
  ...
  let s:ctermshade7 = 223
  let s:ctermaccent0 = 210
  let s:ctermaccent1 = 221
  let s:ctermaccent2 = 246
  let s:ctermaccent3 = 185
  let s:ctermaccent4 = 203
  let s:ctermaccent5 = 203
  let s:ctermaccent6 = 203
